...
if(isset($_POST['submit']))
{
    ...
    $sql="update `company` set companyid=$id,cname='$cname',email='$email',contractdate='$contract',mobile='$mobile',address='$address',country='$country',rank=$rank,linkedin='$linkedin'   where companyid=$id ";
    $result=mysqli_query($con,$sql);
...
<div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" placeholder="Enter Country" name="country" value=
     <?php
     echo $country;
     ?>>
    </div>
    ...
    <div class="form-group">
      ...
      <label class="form-label mt-4">value=
     <?php
     echo "Current Company's Rank= $rank";
     ?></label>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" placeholder="Enter LinkedIn" name="linkedin"  value=
     <?php
     echo $linkedin;
     ?>>
    </div>
